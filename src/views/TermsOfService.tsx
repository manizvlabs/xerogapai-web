    ...
    <>
      ...
      <Section>
        <div className="max-w-3xl mx-auto">
          <div className="p-5 bg-primary-50 border border-primary-200 rounded-xl mb-10">
          ...
          <TermsSection title="2. Description of Services">
            ...
            <ul className="list-disc pl-5 space-y-1 text-text-secondary mt-2">
              <li><strong>AI Review Generator</strong> — a platform that helps businesses collect customer feedback and generate Google review text using artificial intelligence</li>
              <li><strong>AgentMitra</strong> — a role-based service operations platform for managing agent workflows and client interactions</li>
            </ul>
            <p className="mt-3">
