        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-green-100">AI-powered scoring eliminates human bias and ensures consistency</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-4">⚡</div>
              <h3 className="text-xl font-semibold text-white mb-2">40% Performance Boost</h3>
              <p className="text-green-100">Real-time coaching and personalized training improve agent effectiveness</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-4">💰</div>
              <h3 className="text-xl font-semibold text-white mb-2">$25K+ Annual Savings</h3>
              <p className="text-green-100">Per QA analyst through automated evaluation and reduced manual review time</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-green-100">Contact Centers</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">10M+</div>
                <div className="text-sm text-green-100">Calls Analyzed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">95%</div>
                <div className="text-sm text-green-100">QA Accuracy</div>
              </div>
              <div className="text-center">
