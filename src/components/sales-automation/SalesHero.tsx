...
export default function SalesHero() {
  return (
    <div className="relative isolate bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900">
      {/* Background Pattern */}
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-12 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700">
              <UserGroupIcon className="h-8 w-8 text-teal-400 mx-auto mb-3" />
              <div className="text-3xl font-bold text-white mb-1">85%</div>
              <div className="text-sm text-slate-400">Higher Conversion Rate</div>
            </div>

            <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700">
              <CursorArrowRaysIcon className="h-8 w-8 text-cyan-400 mx-auto mb-3" />
              <div className="text-3xl font-bold text-white mb-1">60%</div>
              <div className="text-sm text-slate-400">Faster Sales Cycle</div>
            </div>

            <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-slate-700">
              <BoltIcon className="h-8 w-8 text-emerald-400 mx-auto mb-3" />
              <div className="text-3xl font-bold text-white mb-1">24/7</div>
              <div className="text-sm text-slate-400">Automated Prospecting</div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <div className="font-semibold text-white">Intelligent Lead Generation</div>
                    <div className="text-sm text-slate-300">AI finds and qualifies prospects automatically</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    <div className="font-semibold text-white">Personalized Outreach</div>
                    <div className="text-sm text-slate-300">Tailored messaging based on prospect data</div>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <div className="font-semibold text-white">Sales Intelligence</div>
                    <div className="text-sm text-slate-300">Real-time insights on prospects and deals</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    <div className="font-semibold text-white">CRM Integration</div>
                    <div className="text-sm text-slate-300">Seamlessly sync with your existing sales tools</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-700">
            ...
            <div className="flex items-center justify-center space-x-8 opacity-70">
              <div className="text-center">
                ...
                <div className="text-xs text-slate-400">Sales Teams</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">$50M+</div>
                <div className="text-xs text-slate-400">Revenue Generated</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">95%</div>
                <div className="text-xs text-slate-400">Lead Quality Score</div>
              </div>
            </div>
          </div>
        </div>
