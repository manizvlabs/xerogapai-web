      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-white">Companies Compliant</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-orange-600 mb-2">₹500Cr</div>
            <div className="text-sm text-gray-600 dark:text-white">Penalties Avoided</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-orange-600 mb-2">98%</div>
            <div className="text-sm text-gray-600 dark:text-white">Assessment Accuracy</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-orange-600 mb-2">85%</div>
            <div className="text-sm text-gray-600 dark:text-white">Client Satisfaction</div>
          </div>
        </div>
      </div>
    </section>
