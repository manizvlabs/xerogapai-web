            ...
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-600">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 px-3 py-1 rounded-full text-sm font-medium">
                    {useCase.impact}
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl p-8 text-white text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-sm text-indigo-100">Isolated knowledge bases</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="text-3xl mb-2">🔒</div>
              <div className="font-semibold mb-1">Zero Trust</div>
              <div className="text-sm text-indigo-100">End-to-end security</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="text-3xl mb-2">📊</div>
              <div className="font-semibold mb-1">Enterprise Analytics</div>
              <div className="text-sm text-indigo-100">Advanced reporting</div>
            </div>
          </div>
        </div>
      </div>
