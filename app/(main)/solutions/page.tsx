...
export const metadata: Metadata = {
  title: 'VyaptIX Products — AI Review Generator, Setu & BankLens',
  description:
    'Three AI products built for real business outcomes: AI Review Generator, Setu, and BankLens. See how VyaptIX transforms business operations.',
  openGraph: {
    title: 'VyaptIX Products — AI Review Generator, Setu & BankLens',
    description:
